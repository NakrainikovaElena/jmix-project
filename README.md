...
To start the application, use the **MovieCatalog Jmix Application** run configuration in your IDE, or run the following command in the project root directory:
